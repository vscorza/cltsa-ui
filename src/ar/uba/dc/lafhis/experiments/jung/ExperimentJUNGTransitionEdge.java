 ...
 */
public class ExperimentJUNGTransitionEdge {
	private ArrayList<String> transitionLabels;
	private String transitionLabel;
	private int originState;
	private int destinationState;
	
	public ExperimentJUNGTransitionEdge(String name, int origin, int dest) {
	...
	public String toString() {
		if (transitionLabel == null) {
			transitionLabel = "";
			if(transitionLabels.size() > 1) transitionLabel += "<";
