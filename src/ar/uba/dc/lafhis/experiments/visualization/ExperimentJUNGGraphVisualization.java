package ar.uba.dc.lafhis.experiments.visualization;
...
public class ExperimentJUNGGraphVisualization extends ExperimentResultVisualization {
	...
	protected VisualizationViewer<ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String,Long,String>> visualizationViewer;
	protected VisualizationImageServer<ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String,Long,String>> visualizationServer;
	...
	public VisualizationViewer<ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String,Long,String>> getVisualizationViewer(){
	...
	protected void initializeViewer() throws Exception{
		...
		DirectedSparseMultigraph<ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String,Long,String>> graph = (DirectedSparseMultigraph)jsonObject.getValue();
		
		 // The Layout<V, E> is parameterized by the vertex and edge types
		 Layout<ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String,Long,String>> layout = new ISOMLayout<ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String,Long,String>>((Graph<ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long,String>>) graph);
		 layout.setSize(dimension); // sets the initial size of the space
		 // The BasicVisualizationServer<V,E> is parameterized by the edge types
		 
		 
		visualizationViewer =
		 new VisualizationViewer<ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String,Long,String>>(layout);
		 ...
		 Transformer<ExperimentJUNGGameEdgeValue<String,Long,String>, Stroke> edgeStrokeTransformer = new Transformer<ExperimentJUNGGameEdgeValue<String,Long,String>, Stroke>() {
		 public Stroke transform(ExperimentJUNGGameEdgeValue<String,Long,String> edge) {
